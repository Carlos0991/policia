          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="articulo.php"><i class="fa fa-circle-o"></i> Provincia</a></li>
                <li><a href="categoria.php"><i class="fa fa-user"></i> Distritos</a></li>
                <li><a href="categoria.php"><i class="fa fa-police"></i> Circuitos</a></li>
                <li><a href="categoria.php"><i class="fa fa-circle-o"></i> Subcircuitos</a></li>
